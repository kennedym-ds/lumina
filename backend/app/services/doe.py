...
def fractional_factorial(factors: list[dict[str, Any]], fraction: int = 1) -> dict[str, Any]:
    ...
    # Compute resolution: the minimum word length across the full defining relation.
    # Each generator contributes a word = its base interaction columns combined with
    # the aliased factor it defines. The defining relation is the group generated by
